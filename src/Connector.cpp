...
void Connector::Bulk_Insert(int oram_index, std::vector<int> pos, std::vector<std::string> cipher)
{
    size_t num = pos.size();
...
std::string Connector::Query(int oram_index, int pos)
{
...
void Connector::Update(int oram_index, int pos, std::string cipher)
{
